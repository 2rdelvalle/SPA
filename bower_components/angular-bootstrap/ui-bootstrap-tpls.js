...
.directive('uibTabset', function() {
  return {
    ...
    link: function(scope, element, attrs) {
      ...
      scope.tituloTab = attrs.titleHeaderTab;
    }
  };
})
...
angular.module("uib/template/tabs/tabset.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/tabs/tabset.html",
    ...
    "<span>{{tituloTab}}</span>"+
    "<ul class=\"ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all nav-{{tabset.type || 'tabs'}}\" ng-class=\"{'nav-stacked': vertical, 'nav-justified': justified}\" ng-transclude></ul>\n" +
    "</h3>"+
