      ...
      controller: [
        ...
        function ($scope, $interval, growl, growlMessages) {
          ...
          $scope.alertClasses = function (message) {
            return {
              'alert-success-toast': message.severity === 'success',
              'alert-error-toast': message.severity === 'error',
              'alert-danger-toast': message.severity === 'error',
              'alert-info-toast': message.severity === 'info',
              'alert-warning-toast': message.severity === 'warning',
