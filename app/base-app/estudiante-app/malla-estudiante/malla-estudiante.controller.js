'use strict';
angular.module('mytodoApp').controller('MallaEstudianteCtrl', ['$scope', 'mallaEstudianteService', '$location', 'ValidationService', 'localStorageService', '$timeout', '$http', '$window', 'liquidarMatriculaService', 'appConstant', 'appGenericConstant', 'appConstantValueList',
    function ($scope, mallaEstudianteService, $location, ValidationService, localStorageService, $timeout, $http, $window, liquidarMatriculaService, appConstant, appGenericConstant, appConstantValueList) {
        ...
        gestionMalla.detalleMallaAcademicaTotal = [];
        ...
        function onConsultarProgramas() {
            liquidarMatriculaService.consultarEstudianteAll(gestionMalla.usuario.identificacion, 'MallEst').then(function (data) {
                ...
                if (data === "") {
                    ...
                    gestionMalla.mallaEntity.programaAcademico = null;
                    mallaEstudianteService.consultarProgramas(gestionMalla.usuario.identificacion).then(function (data) {
