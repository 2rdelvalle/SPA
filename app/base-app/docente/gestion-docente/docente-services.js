(function () {
    'use strict';
    angular.module('mytodoApp.service').service('docenteEntitiesServices', docenteEntitiesServices);
    docenteEntitiesServices.$inject = ['$http', '$q', 'appGenericConstant'];

    function docenteEntitiesServices($http, $q, appGenericConstant) {
        var servicio = this;
        ...
        servicio.getSedes = getSedes;
        servicio.consultarSeccional = getSeccional;
        servicio.getFuncionario = getFuncionario;
        servicio.getFoto = getFoto;
        var url ='/api/docente/';
