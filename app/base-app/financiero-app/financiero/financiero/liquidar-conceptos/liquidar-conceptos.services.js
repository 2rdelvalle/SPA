(function () {
    ...
    angular.module('mytodoApp.service').service('liquidarConceptosService', liquidarConceptosService);

    liquidarConceptosService.$inject = ['$http', '$q'];

    function liquidarConceptosService($http, $q) {
